<?php
  ...
  ?>
            ...
            <ul	class="control">
              <p><a href="#">Hình thanh toán: Giao tiền khi nhận hàng|</a></p>
                <p><a href="?quanly=thaydiachi">Thay đổi địa chỉ giao hàng</a></p>
                <?php
				if(isset($_SESSION['dangnhap'])&&isset($_SESSION['product'])){
				?>
                 <p style="float:right; background:#FF0;text-decoration:none;"><a href="thanhtoan.php" style="color:#000;margin:5px;">Đặt Hàng</a></p>
				<?php
				}
				?>
        	</ul>
