...
<div class="menu">
    	<ul>
            ...
            <li><a href="index.php?quanly=user&ac=lietke">Quản lý người dùng</a></li>
            <form action="" method="post" enctype="multipart/form-data">
            <input type="submit" name="logout" value="Đăng xuất" style="background:#06F;color:#fff;width:100px;height:20px;" />
            </form>
        </ul>
